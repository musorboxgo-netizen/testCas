...
ENTRYPOINT ["java", "-server", "-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=*:5005", "-noverify", "-Xmx2048M", "-XX:SharedArchiveFile=cas/cas.jsa", "-jar", "cas/cas.war"]
