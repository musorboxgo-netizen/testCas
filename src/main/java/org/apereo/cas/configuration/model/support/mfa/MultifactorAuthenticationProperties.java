...
public class MultifactorAuthenticationProperties implements Serializable {
    ...
    /**
     * Activate and configure a multifactor authentication provider via Inalogy Authenticator.
     */
    @NestedConfigurationProperty
    private InalogyAuthenticatorMultifactorProperties inalogy = new InalogyAuthenticatorMultifactorProperties();
