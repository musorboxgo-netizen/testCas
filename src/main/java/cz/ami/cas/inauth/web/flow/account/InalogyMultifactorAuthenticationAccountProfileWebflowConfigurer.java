...
public class InalogyMultifactorAuthenticationAccountProfileWebflowConfigurer extends MultifactorAuthenticationAccountProfileWebflowConfigurer {
    ...
    protected void doInitialize() {
        ...
        myAccountView.getRenderActionList().add(createEvaluateAction(CasWebflowConstants.ACTION_ID_ACCOUNT_PROFILE_INALOGY_MFA_PREPARE));
        ...
        regViewState.getEntryActionList().add(createEvaluateAction(CasWebflowConstants.ACTION_ID_ACCOUNT_PROFILE_INALOGY_MFA_REGISTRATION));
        regViewState.getEntryActionList().addAll(createEvaluateAction(CasWebflowConstants.ACTION_ID_INALOGY_ACCOUNT_CREATE_REGISTRATION));
        ...
        val acctRegSaveState = createActionState(accountFlow, CasWebflowConstants.STATE_ID_INALOGY_SAVE_REGISTRATION,
            createEvaluateAction(CasWebflowConstants.ACTION_ID_INALOGY_SAVE_ACCOUNT_REGISTRATION));
        createTransitionForState(acctRegSaveState, CasWebflowConstants.TRANSITION_ID_SUCCESS, CasWebflowConstants.STATE_ID_MY_ACCOUNT_PROFILE_INALOGY_REGISTRATION_FINALIZED);
        ...
        val acctRegFinalize = createActionState(accountFlow, CasWebflowConstants.STATE_ID_MY_ACCOUNT_PROFILE_INALOGY_REGISTRATION_FINALIZED, finalizeRegistrationAction);
