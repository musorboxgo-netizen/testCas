...
@Getter
@Slf4j
public class JsonInalogyAuthenticatorTokenCredentialRepository extends BaseInalogyAuthenticatorTokenCredentialRepository {
    ...
    public JsonInalogyAuthenticatorTokenCredentialRepository(
